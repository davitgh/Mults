...
public class ProfileWatchlistFragment extends Fragment {
    ...
    private ArrayList<Mult> watchlistMults;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_profile_watchlist, container, false);

        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabase.child("Watchlist").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        watchlistMults = new ArrayList<>();

        RecyclerView rvLike = (RecyclerView) v.findViewById(R.id.rv_watchlist_mults);
        rvLike.setHasFixedSize(true);
        mAdapter = new LikeListAdapter(getContext(), watchlistMults);
